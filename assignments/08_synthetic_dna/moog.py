...
Author : lia
Date   : 2020-04-01
Purpose: Create synthetic dna/rna
"""
...
def main():
    ...
    sequence = 'sequence' if args.numseqs == 1 else 'sequences'
    print(f'Done, wrote {args.numseqs} {args.seqtype.upper()} {sequence} to "{args.outfile.name}".')
